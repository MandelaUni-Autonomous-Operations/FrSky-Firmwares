...
This Package is for RX8R PRO ACCST v2.1.0 firmware update. 

Version and Files: 
RX8R_Pro_ACCST_V2.1.0_FCC.frk                              Firmware under NonLbt mode which is certificated for FCC rules. 
RX8R_Pro_ACCST_V2.1.0_LBT.frk                               Firmware under LBT mode which is certificated for CE rules.  
